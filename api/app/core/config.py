...
class Settings:
    ...
    enable_e2e_monitoring: bool = getenv("ENABLE_E2E_MONITORING", "true").lower() == "true"
    enable_journey_optimization: bool = getenv("ENABLE_JOURNEY_OPTIMIZATION", "true").lower() == "true"
    enable_error_experience: bool = getenv("ENABLE_ERROR_EXPERIENCE", "true").lower() == "true"
    enable_performance_optimization: bool = getenv("ENABLE_PERFORMANCE_OPTIMIZATION", "true").lower() == "true"
    ...
    enable_inapp_rate_limit: bool = getenv("ENABLE_INAPP_RATE_LIMIT", "true").lower() == "true"
    enable_inapp_auth: bool = getenv("ENABLE_INAPP_AUTH", "false").lower() == "true"
